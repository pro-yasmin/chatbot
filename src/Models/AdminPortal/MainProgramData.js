...
export class MainProgramData {
  ...
  getEnglishMainProgramName() {
    if (this.englishMainProgramName == null) {
      this.englishMainProgramName = global.testConfig.createMainProgram.englishMainProgramName + this.utils.generateRandomEnglishString(5)+" "+"Auto";
    }
  ...
  getResponsibleEntity()  {
    if (this.responsibleEntity == null) {
      this.responsibleEntity = global.testConfig.createMainProgram.responsibleEntity;
    }
  ...
  getArabicMainProgramDescription() {
    if (this.arabicMainProgramDescription == null) {
      this.arabicMainProgramDescription = global.testConfig.createMainProgram.arabicMainProgramDescription + this.utils.generateRandomArabicString(10);
    }
  ...
  getEnglishMainProgramDescription() {
    if (this.englishMainProgramDescription == null) {
      this.englishMainProgramDescription = global.testConfig.createMainProgram.englishMainProgramDescription + this.utils.generateRandomEnglishString(10);
    }
  ...
  getCalculationMethod() {
    if (this.calculationMethod == null) {
      this.calculationMethod = global.testConfig.createMainProgram.calculationMethod + this.utils.generateRandomArabicString(10);
    }
  ...
  getEstimatedBudget() {
    if (this.estimatedBudget == null) {
      this.estimatedBudget = global.testConfig.createMainProgram.estimatedBudget + this.utils.generateRandomArabicString(5);
    }
  ...
  getRiskArabicDescription()  {
    if (this.riskArabicDescription == null) {
      this.riskArabicDescription = global.testConfig.createMainProgram.riskArabicDescription + this.utils.generateRandomArabicString(10);
    }
  ...
  getRiskEnglishDescription()  {
    if (this.riskEnglishDescription == null) {
      this.riskEnglishDescription = global.testConfig.createMainProgram.riskEnglishDescription + this.utils.generateRandomEnglishString(10);
    }
  ...
  getArabicMainProgramGoal() {
    if (this.arabicMainProgramGoal == null) {
      this.arabicMainProgramGoal = global.testConfig.createMainProgram.arabicMainProgramGoal + this.utils.generateRandomArabicString(8);
    }
  ...
  getEnglishMainProgramGoal() {
    if (this.englishMainProgramGoal == null) {
      this.englishMainProgramGoal = global.testConfig.createMainProgram.englishMainProgramGoal + this.utils.generateRandomEnglishString(8);
    }
