...
test('Preview IBR List Details', async ({ page }) => {
    ...
    // Step4: Filter IBR List Preview page
    await test.step('Filter IBR List Preview page', async () => {
        expect(await isrListPreviewPage.filterListPreviewPage()).toBe(true);
        console.log('IBR List Preview page Filtered successfully');
    });
